...
TYPE_EXPERTS_APPEARANCES = {
  ...
  # Hoenn designers
  :DESIGNER_KANTO => TrainerAppearance.new(5, "ash", "leaf", "2_mistyRBY", 210, 0, 0),
  :DESIGNER_JOHTO => TrainerAppearance.new(5, "kris", "kris", "1_lyra", 0, 0, 0),
  :DESIGNER_SINNOH => TrainerAppearance.new(5, "dawnDPP", "leaf", "2_dawn", 210, 0, 0),
  :DESIGNER_UNOVA => TrainerAppearance.new(5, "hilbert", "red", "1_nhair", 0, 0, 0),
  :DESIGNER_KALOS => TrainerAppearance.new(5, "serena", "Ramos", "2_naveen", 0, 0, 0),
  :DESIGNER_ALOLA => TrainerAppearance.new(5, "seleneUSUM", "leaf", "2_mistyRBY", 0, 0, 0),
